    ...
    <section className="my-[75px] xl:my-[150px] border-t-2" data-aos="fade-up">
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row justify-between items-center">
          {/* text */}
          <div className="py-12 xl:py-24 text-center xl:text-left  dark:text-white">
            <h2
              className="h2 mb-5  dark:text-white"
              data-aos="fade-up"
              data-aos-delay="300 "
            >
              {title}
            </h2>
            <p className="lead  dark:text-gray-300" data-aos="fade-up">
              {subtitle}
            </p>
          </div>
          {/* buttons */}
