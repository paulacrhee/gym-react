      ...
      <div className="container mx-auto  dark:text-white">
        <div className="flex flex-col xl:flex-row text-center xl:text-left gap-y-12 ">
          ...
          <div className="w-[45%] mx-auto flex flex-col items-center xl:items-start ">
            {/* logo */}
            <a href="/">
              <img className="mb-[65px]  dark:text-white" src={logo} alt="" />
            </a>
            {/* address */}
            <div className="max-w-[260px] mb-5 text-primary  dark:text-white font-bold">
              {address}
            </div>
            {/* email */}
          ...
          <div className="flex flex-1 flex-col gap-y-14 xl:flex-row justify-between">
            {/* list 1 */}
            <div>
              <div className="font-extrabold text-primary mb-8  dark:text-white">
                About
              </div>
            ...
            {/* list 2 */}
            <div>
              <div className="font-extrabold text-primary  dark:text-white mb-8">
                Help
              </div>
              <ul className="flex flex-col gap-y-4">
